...
LESSON 10 — GROWTH-CORRIDOR IN-MIGRATION ABSORBS APARTMENT TRANSIENCE:
Critical correction to the transience penalty. Apartment transience is ONLY a kill criterion when the demographic isn't being replenished (Stamford CT pattern: NYC commuter shadow, no in-migration to replace movers). In growth-corridor markets with continuous professional in-migration, apartment churn is REPLENISHED faster than members leave. The location stabilizes around a moving steady-state of always-fresh young professionals.
Confirmed by: Charlotte South End (LYNX Rail Trail corridor, top-performer in the franchisee portfolio despite heavy luxury apartment density), Austin St Elmo (300+ members despite renter-heavy mix), Cincinnati Woodburn (290 at 18mo despite Woodburn Exchange 322-unit luxury rental directly across the street), 14th St DC (320 members despite transient Logan Circle / U Street pipeline).
APPLY THIS RULE: do NOT downgrade housing or stability for apartment-heavy mixes IF the location is in a recognized growth corridor with continuous professional in-migration. Examples of growth corridors that get this benefit: Charlotte South End / Plaza Midwood / NoDa, Austin South Congress / East Austin / Mueller, Nashville Gulch / East Nashville / Wedgewood-Houston, Atlanta BeltLine corridor (residential portions), Dallas Bishop Arts / Deep Ellum, Denver RiNo / LoHi residential, Tampa Heights / South Tampa, Phoenix Roosevelt Row, Indianapolis Mass Ave, Cincinnati OTR / Walnut Hills, Columbus Short North residential edge. The transience pipeline is FUEL not friction.
EXCEPTIONS where transience IS still a problem: pure entertainment-district transience (visitors not residents), college-student turnover (academic calendar churn), pure NYC/SF commuter shadow (no local in-migration), tourism-dominant transience.

LESSON 11 — OVERSATURATION IS ABSORBABLE IN STRONG URBAN VILLAGES:
Oversaturation alone doesn't kill a location. The pattern: strong urban village + bullseye demo + true habit corridor + sharp execution = wins despite competition. Confirmed by: Cincinnati Woodburn (Fitness Clarified literally 3 doors away, hits 290), Charlotte South End (Barry's, Solidcore, OTF, F45 all stacked, top performer), Arlington VA (oversaturated DC suburb, ~300 members). Saturation only kills when paired with another structural drag (stroad, off-path positioning, ultra-luxury fragmentation, or weak fundamentals). Don't blanket-penalize competition in growth-corridor markets — score it 5-7 instead of 3-4 if the layout is true urban village.

LESSON 12 — MARKET-SPECIFIC DRIVE TOLERANCE (NOT UNIVERSAL CAR-DEPENDENCE PENALTY):
Drive-tolerance varies by metro culture. Don't apply the same car-dependence penalty across all markets. Three categories:
- WALKABILITY-MANDATORY METROS: NYC, Boston core, SF, DC core, Chicago Loop. Residents expect to walk. Car-dependent location = real penalty.
- SUN BELT DRIVE-DEFAULT METROS: Charlotte, Atlanta, Nashville, Austin (most), Dallas, Denver suburbs, Tampa, Phoenix, Houston. Residents drive everywhere as cultural default. "Car-dependent" is NOT a meaningful penalty by itself. The actual question: is traffic bad during class times (6am, noon, 5-7pm)? If traffic is manageable, score normally.
- SMALL/MID MARKETS: Charlottesville, Winchester, Boise, etc. Drive everywhere is expected. Walking-equivalent isn't required.
Apply: when scoring Charlotte South End, Atlanta neighborhoods, Nashville urban corridors, Austin growth areas, do NOT penalize "car-dependent" or "drive-to" by itself. Only penalize trade_area when there's an actual traffic problem during class times.
